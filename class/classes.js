...
class Fighter extends Sprite {
  ...
  attack() {
    this.swithSprite("attack2");
    this.isAttacking = true;
  }
  takeHit() {
    this.health -= 10;
    if (this.health <= 0) {
      this.swithSprite("die");
    } else {
      this.swithSprite("takeHit");
    }
  }

  //it was switchSprite but when i realized it was too late haha!
  swithSprite(sprite) {
    ...
    //Overriding animations with the hit animation
    if (
